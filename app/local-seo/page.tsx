...
export const metadata: Metadata = {
  title: `${service.name} Services UK | ${service.title}`,
  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {cities.map((city) => (
              <Link
                key={city.slug}
                href={`/local-seo/local-seo-agency-${city.slug}/`}
      ...
      <CTASection 
        ...
        description="Get a free audit and see exactly where you stand against your competitors."
        variant="dark"
      />
    </>
  );

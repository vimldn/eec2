...
export default function LocalSEOCityPage({ params }: { params: { city: string } }) {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 py-16 max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
            Local SEO Agency in <span className="text-brand">{city.name}</span>
          </h1>
      ...
      {/* Why Local SEO Matters - Unique Content */}
      <section className="px-6 py-20 bg-dark-lighter">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <p className="section-label">Why Local SEO Matters in {city.name}</p>
            <h2 className="text-2xl md:text-3xl font-bold mb-6">
              Reach {city.population} potential customers in {city.region}
            </h2>
            <div className="text-text-muted space-y-4 leading-relaxed">
              <p>{city.localSeo.why}</p>
              <p>{city.localSeo.industries}</p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-dark-card border border-white/[0.08] rounded-xl p-6">
              <h3 className="font-semibold mb-4">{city.name} at a Glance</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between py-2">
                  <span className="text-text-muted">Business Areas</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { number: '88%', label: 'of local searches call within 24hrs' },
                { number: '76%', label: 'of local searchers visit same day' },
                { number: '28%', label: 'of local searches buy' }
              ].map((stat, i) => (
      ...
      <section className="px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-text-secondary text-center max-w-2xl mx-auto mb-10">
            Everything you need to dominate local search in {city.name} and across {city.region}
          </p>
      ...
      <section className="px-6 py-20 bg-dark-lighter">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl font-bold mb-10 text-center">
            Local SEO Questions for {city.name} Businesses
          </h2>
      ...
      <CTASection 
        title={`Ready to dominate local search in ${city.name}?`}
      ...
      <section className="px-6 py-12 bg-dark-lighter border-t border-white/[0.08]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-4">
            <Link href="/local-seo/" className="text-brand hover:underline text-sm">
